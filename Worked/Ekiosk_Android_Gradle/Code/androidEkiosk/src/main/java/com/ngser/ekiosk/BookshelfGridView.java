    ...
    public BookshelfGridView(Context context, int position) {
        ...
        setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getContext().getApplicationContext(), com.artifex.mupdflib.MuPDFActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                ...
                //document name
                intent.putExtra("docname", editions_data.get(position).getLocalPath());
