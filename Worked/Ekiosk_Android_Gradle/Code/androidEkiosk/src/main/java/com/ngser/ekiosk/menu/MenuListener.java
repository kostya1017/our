...
import com.ngser.ekiosk.kiosque.AppSlideShowActivity;
import com.ngser.ekiosk.kiosque.AppSlideShowViewPagerActivity;
...
public class MenuListener {
    ...
    public MenuListener(View menuView, Context tempcontext) {
        ...
        aideButton = (Button) menuView.findViewById(R.id.aideButton);
    ...
    private void setupNotConnected() {
        ...
        aideButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent slideShowActivity = new Intent(mContext, AppSlideShowViewPagerActivity.class);
                slideShowActivity.putExtra("isFromMenu", true);
                mContext.startActivity(slideShowActivity);
            }
        });
    }
