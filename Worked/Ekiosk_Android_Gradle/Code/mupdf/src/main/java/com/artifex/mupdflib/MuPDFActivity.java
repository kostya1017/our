...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport {
    ...
    private boolean mAlertsActive = false, needBottomPreview = true;
    ...
    public static final String ACTION_DONE = "android.intent.action.DONE";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("needBottomPreview")) {
            needBottomPreview = getIntent().getBooleanExtra("needBottomPreview", true);
        }
    ...
    public void createUI(Bundle savedInstanceState) {
		...
		*/
        ...
        int pageNum = prefs.getInt("page" + core.getFileName(), 0);
...
*/
    ...
    */
    ...
    private void makeButtonsView() {
        mButtonsView = LayoutInflater.from(MuPDFActivity.this).inflate(R.layout.buttons, null);
        // ///////mFilenameView =
        // (TextView)mButtonsView.findViewById(R.id.docNameText);
        ///mPageSlider = (SeekBar) mButtonsView.findViewById(R.id.pageSlider);
        doneTv = (TextView) mButtonsView.findViewById(R.id.done_tv);
        doneTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (getIntent().hasExtra("isFromMenu") && getIntent().getBooleanExtra("isFromMenu", false)) {
                    finish();
                    Intent i = new Intent(ACTION_FINISH);
                    sendBroadcast(i);
                } else {
